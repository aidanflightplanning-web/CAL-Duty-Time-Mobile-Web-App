...
def calculate_crew_times():
    ...
    if 6 <= hour < 7.59:
        mapping = {1: 13.25, 2: 13.25, 3: 12.5, 4: 10.75, 5: 10.0, 6: 9.5, 7: 9.0, 8: 9.0}
    elif 8 <= hour < 12.59:
        mapping = {1: 14.0, 2: 13.25, 3: 12.5, 4: 11.75, 5: 11.0, 6: 10.5, 7: 10.0, 8: 9.0}
    elif 13 <= hour < 17.59:
        mapping = {1: 13.0, 2: 12.25, 3: 11.5, 4: 10.75, 5: 10.0, 6: 10.0, 7: 9.0, 8: 9.0}
    elif 18 <= hour < 21.59:
        mapping = {1: 12.25, 2: 12.25, 3: 10.5, 4: 9.75, 5: 9.0, 6: 9.0, 7: 9.0, 8: 9.0}
    else:
        mapping = {1: 11.0, 2: 10.25, 3: 9.5, 4: 9.0, 5: 9.0, 6: 9.0, 7: 9.0, 8: 9.0}
